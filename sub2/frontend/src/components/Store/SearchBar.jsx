...
class Search extends React.Component {
  ...
  getSearchStore = async () => {
    ...
    try {
      this.setState({ id: window.localStorage.getItem("userInfo") });
      if (search === "") {
        this.setState({ storesAll: [], isLoading: false });
      } else {
        const {
          data: { results },
        } = await axios.get("http://i02a205.p.ssafy.io:8001/api/stores", {
        ...
        this.setState({ stores: results, isLoading: false, searchState: true });
      }
    } catch (error) {
      console.log(error);
    }
  ...
  //   this.setState({filter: nextProps.checks})
  //   return
  // }
            ...
            <div>
              ...
              <div className="input_div">
                ...
                <div className="stores">
                  {" "}
                  {this.searchState && <h3>라이프스타일에 맞는 음식점은</h3>}
