...
const MeetView3 = () => {
    ...
    return (
        <div>
            ...
            <br/>
            <FormControl className={classes.formControl}>
                <InputLabel id="demo-mutiple-checkbox-label">Main -> Sub Life</InputLabel>
                <Select
                    labelId="demo-mutiple-checkbox-label"
                    id="demo-mutiple-checkbox"
                    multiple
                    ...
                    renderValue={(selected) => {
                        selected.join(', ')
                        return Object.keys(secondLife).length + "개의 항목이 선택되었습니다.";
                    }}
                    MenuProps={MenuProps}
                >
            ...
            <hr/>
            <MeetResultView2 sendArea={sendArea} sendLife={sendLife} sendString={sendString} />
        </div>
    );

};

export default MeetView3;