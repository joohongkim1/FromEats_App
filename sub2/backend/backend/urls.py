...
urlpatterns = [
    ...
    path("api/", include("api.urls")), # dining app
    # path("account/", include("account.urls")), # account app
    path("rest-auth/", include("rest_auth.urls")),
    path("rest-auth/registration/", include("rest_auth.registration.urls")),
    path("social/", include("allauth.urls")), #http://127.0.0.1:8000/social/google/login/
    # Auto DRF API docs
    path('swagger<str:format>', schema_view_v1.without_ui(cache_timeout=0)),
